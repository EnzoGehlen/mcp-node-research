...
export const registerWifiResources = (server) => {
    // Get all WiFi networks
    server.resource("wifi-networks", new ResourceTemplate("router://wifi/networks", { list: undefined }), async () => {
    ...
    server.resource("wifi-network-detail", new ResourceTemplate("router://wifi/networks/{networkId}", { list: undefined }), async (uri, { networkId }) => {
