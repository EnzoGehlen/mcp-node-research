import { z } from "zod";
export const registerRouterPrompts = (server) => {
    // Prompt for troubleshooting WiFi issues
    server.prompt("troubleshoot-wifi", {
        problem: z.string(),
...
Additionally, provide an overall assessment of my router's health based on these logs.`
    ...
    server.prompt("security-assessment", {
