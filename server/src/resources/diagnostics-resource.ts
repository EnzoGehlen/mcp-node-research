...
export const registerDiagnosticsResources = (server: McpServer): void => {
  // Get system diagnostics
  server.resource(
    "system-diagnostics",
    new ResourceTemplate("router://diagnostics/system", { list: undefined }),
    async () => {
  ...
  server.resource(
    ...
    new ResourceTemplate("router://diagnostics/connection", { list: undefined }),
    async () => {
  ...
  server.resource(
    "system-logs",
    new ResourceTemplate("router://diagnostics/logs", { list: undefined }),
    async () => {
  ...
  server.resource(
    "logs-by-level",
    new ResourceTemplate("router://diagnostics/logs/{level}", { list: undefined }),
    async (uri, { level }) => {
